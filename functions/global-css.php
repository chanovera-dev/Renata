        ...
        <style>
            ...
            *,:before,:after{box-sizing:border-box;margin:0;}
            ...
            #menu-mobile ul li a:hover{background-color:var(--wp--preset--color--white);}
                ...
                #menu-mobile > ul li.menu-item-has-children > ul.sub-menu li:first-child a{box-shadow:inset 0px 17px 11px -15px rgb(0 0 0 / 15%);}
                #menu-mobile > ul li.menu-item-has-children > ul.sub-menu li:last-child a{box-shadow:inset 0px -17px 11px -15px rgb(0 0 0 / 15%);}
