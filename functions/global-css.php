    ...
    ?>
        <style>
            ...
            *,:before,:after{box-sizing:border-box;margin:0;}
            ...
            #menu-mobile ul li :is(a, button){display:flex;width:100%;padding:12px 20px;background-color:var(--wp--preset--color--bg-panel);font-size:16px;font-family:'Roboto';border:none;transition:background-color .3s ease;}
