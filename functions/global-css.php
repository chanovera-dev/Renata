    ...
    ?>
        <style>
            ...
            *,:before,:after{box-sizing:border-box;margin:0;}
            ...
            .navigation.pagination .nav-links .page-numbers:not(.next){display:flex;justify-content:center;width:30px;padding:10px 0;background-color:var(--wp--preset--color--bg-panel);border-radius:6px;}
            .navigation.pagination .nav-links .page-numbers.next{padding:10px;background-color:var(--wp--preset--color--bg-panel);border-radius:6px;}
        </style>
    <?php
}
