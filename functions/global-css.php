    ...
    ?>
        <style>
            ...
            *,:before,:after{box-sizing:border-box;margin:0;}
            ...
            :is(.scroll-down,.scroll-up) #mobile-header.main-header{box-shadow:var(--wp--preset--shadow--header);background:var(--wp--preset--color--gb-header-scroll);backdrop-filter:blur(20px);z-index:6;}
            /* menú mobile */
            ...
            /* searchform mobile */
            #searchform-mobile{position:absolute;top:-100%;left:0;width:100%;height:100%;display:flex;align-items:center;padding-left:15px;background-color:var(--wp--preset--color--white);transition:top .3s ease;}
