    ...
    ?>
        <style>
            ...
            *,:before,:after{box-sizing:border-box;margin:0;}
            ...
            /* searchform mobile */
            #searchform-mobile{position:absolute;top:0;left:0;width:100%;height:100%;display:flex;align-items:center;padding-left:15px;background-color:var(--wp--preset--color--white);transition:top .3s ease;}
            /* formulario */
            #searchform-mobile input[type=text]{width:min(100% - 88px);height:34px;border:0 solid transparent;border-radius:6px;background-color:var(--wp--preset--color--panel);padding:8px 15px 8px 10px;font-family:'Roboto';font-size:16px;}
