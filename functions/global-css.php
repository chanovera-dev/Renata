    ...
    ?>
        <style>
            ...
            *,:before,:after{box-sizing:border-box;margin:0;}
            ...
            /* menú mobile */
<<<<<<< HEAD
            #panel-overlay{position:fixed;width:100%;height:100%;top:0;left:-100%;z-index:7;background:rgb(61 70 81 / 90%);backdrop-filter:blur(20px);transition:opacity .3s ease;}
...
=======
            #panel-overlay{position:fixed;width:100%;height:100%;top:0;left:-100%;opacity:1;z-index:7;background:rgb(255 255 255 / 50%);backdrop-filter:blur(20px);transition:opacity .3s ease;}
            #panel-overlay.show{left:0;opacity:1;}
            .menu-mobile--wrapper{position:fixed;top:0;left:-100%;width:100%;max-width:290px;height:100svh;background-color:#f6f6f6;transition:all .3s ease;z-index:8;box-shadow:0 10px 21px rgba(0 0 0 / 25%);}
