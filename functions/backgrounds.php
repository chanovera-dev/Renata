    ...
    ?>
        <style>
            <?php if ( has_post_thumbnail() == false ) : ?>
                ...
                :is(.page-template-default,.post-template-default) main #breadcrumb.container .top{padding:10px 0;}
            ...
            <?php else: ?>
                ...
                :is(.page-template-default,.post-template-default) main .header-post .top :is(.breadcrumb,.breadcrumb a,.category-item a),
