    ...
    <style>
        ...
        p:has(label){margin-bottom:20px;}
            ...
            p:has(label) :is(
                ...
                input[type=url],
                input[type=search],
                textarea){margin-bottom:5px;font-size:13px;}
        ...
        input[type=url],
        input[type=search],
        textarea{padding:10px;background-color:var(--bg-input);border:1px solid var(--border-input);border-radius:6px;font-size:16px;color:var(--color-input);transition:border-color .3s ease;}
