    ...
    ?>
        <style>
            ...
            @media(min-width:1200px){
                ...
                #portfolio.container .content > ul li figure figcaption{position:absolute;top:0;left:0;width:100%;height:100%;opacity:0;transition:opacity .3s ease;}
                @supports ((-webkit-backdrop-filter: initial) or (backdrop-filter: initial)){
                    #portfolio.container .content > ul li figure figcaption{--globalnav-background:rgba(22, 22, 23, .8);}
                }
