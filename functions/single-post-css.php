...
function renata_theme_custom_frontpage_css(){
    ?>
        <style>
            ...
            :is(.page-template-default,.post-template-default) .body-post .section .content-post > h2{font-size:22px;line-height:1.2;font-weight:400;color:var(--resalted-text);margin-top:40px;border-bottom:2px solid var(--color-placeholder);}
        </style>
    <?php
}
