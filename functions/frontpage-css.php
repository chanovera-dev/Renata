    ...
    ?>
        <style>
            ...
            #hero .introduction .contact-me{
                margin-inline:auto;padding:6px 16px;border:2px solid #3fb950;border-radius:6px;background-color:#3fb950;color:#11151A;font-size:20px;margin-top:30px;display:flex;align-items:center;gap:10px;transition:all .3s ease;background-image:linear-gradient(-60deg, transparent, transparent 40%, #ffffff44 40%, #ffffff44 60%, transparent 60%, transparent 100%);background-size:200% 100%;background-position-x:150%;background-repeat:no-repeat;
                animation:bounce-in-right 1.5s 3.5s both;
            }
            #hero .introduction .contact-me:hover{cursor:pointer;background-position-x:-150%;transition:background-position-x 1s;}
            ...
            #portfolio .content .cards-portfolio .card-portfolio{overflow:hidden;background-color:var(--bg-card);box-shadow:rgb(255 255 255 / 5%) 0px 1px 1px 0px inset, rgb(0 0 0 / 15%) 0px 50px 100px -20px, rgb(0 0 0 / 30%) 0px 30px 60px -30px;border-radius:10px;padding:8px;display:grid;opacity:1;transition:background-color .3s ease;}
            ...
            #portfolio .content .cards-portfolio .card-portfolio .technologies-list__wrapper .see-more-button{padding:7px;display:inline-flex;gap:6px;align-items:center;background-color:#3fb950;border:2px solid #3fb950;border-radius:6px;color:#11151A;transition:background-color .3s ease;background-image:linear-gradient(-60deg, transparent, transparent 40%, #ffffff44 40%, #ffffff44 60%, transparent 60%, transparent 100%);background-size:200% 100%;background-position-x:150%;background-repeat:no-repeat;}
            #portfolio .content .cards-portfolio .card-portfolio .technologies-list__wrapper .see-more-button:hover{cursor:pointer;background-position-x:-150%;transition:background-position-x 1s;}
            ...
            #show-form{position:absolute;max-height:0;bottom:20px;right:20px;overflow:hidden;padding:0;border:0;background-color:transparent;color:var(--color-text);font-family:'Roboto';font-size:16px;border-radius:6px;transition:all .3s ease;}
