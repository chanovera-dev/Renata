...
function renata_theme_custom_frontpage_css(){
    ?>
        <style>
            ...
            .page-template-front-page #mobile-header .site-brand{animation-delay:.3s;}
            .page-template-front-page #mobile-header .open-searchform-mobile--button{animation-delay:.6s;}
