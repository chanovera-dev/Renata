...
function renata_theme_custom_frontpage_css(){
    ?>
        <style>
            ...
            #hero .introduction .contact-me{padding:10px 20px;border:2px solid #3fb950;border-radius:6px;background-color:transparent;color:#3fb950;font-size:16em;font-weight:600;margin-top:36px;display:flex;align-items:center;gap:10px;}
