...
function renata_theme_custom_frontpage_css(){
    ?>
        <style>
            ...
            #portfolio .content .cards-portfolio .card-portfolio:nth-child(1){
            ...
            #portfolio .content .cards-portfolio .card-portfolio.card1{
                animation: portfolio-card-1-out both;
                animation-timeline:scroll();
            }
            @keyframes portfolio-card-1-out {
