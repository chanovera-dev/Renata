...
function renata_theme_custom_frontpage_css(){
    ?>
        <style>
            ...
            #portfolio .content > ul > li.card-portfolio.in{transform:translateY(0) rotateX(0) scale(1);transform-origin: 50% 1400px;opacity: 1;animation: slide-in-elliptic-top-fwd 1s cubic-bezier(0.250, 0.460, 0.450, 0.940) both;}
