...
function renata_theme_custom_frontpage_css(){
    ?>
        <style>
            ...
            #portfolio .content > ul > li{overflow:hidden;background-color:#11151A;box-shadow:rgb(255 255 255 / 5%) 0px 1px 1px 0px inset, rgb(0 0 0 / 15%) 0px 50px 100px -20px, rgb(0 0 0 / 30%) 0px 30px 60px -30px;border-radius:10px;padding:5px;padding-bottom:10px;display:grid;gap:16px;}
            #portfolio .content > ul > li figure{position:relative;display:grid;gap:16px;height:100%;}
            #portfolio .content > ul > li figure img{width:100%;aspect-ratio:4/3;object-fit:cover;border-radius:6px;}
            ...
            #portfolio .content > ul li div{display:flex;align-items:center;justify-content:space-between;padding:9px 0;}
