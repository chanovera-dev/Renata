<div id="contact" class="container">
    <section class="section content">
        ...
        <ul class="contact__information--address">
            <li>
                <a href="https://api.whatsapp.com/send?phone=+52<?php echo get_theme_mod('phone_number', '9211243148'); ?>">
            ...
            <li>
                <a href="mailto:contacto@chanovera.com">
