        ...
        <ul>
            <li>
                <figure>
                    <picture>
                        <!--
                        <source srcset="<?php echo get_theme_mod('img_portfolio1_jpg', get_bloginfo('template_url') . '/assets/img/trueOmniDesktop.jpg'); ?>" type="image/jpeg" media="(width => 1096px)">
                    ...
                    <figcaption>
                        ...
                        <a target="_blank" href="https://www.trueomni.com" class="see-more-button" aria-label="Link to the trueomni website">
                            See more
            ...
            <li>
                <figure>
                    <picture>
                        <!-- 
                        <source srcset="<?php echo get_theme_mod('img_portfolio2_jpg', get_bloginfo('template_url') . '/assets/img/pinplastDesktop.jpg'); ?>" type="image/jpeg" media="(width => 1096px)">
                    ...
                    <figcaption>
                        ...
                        <a target="_blank" href="https://www.pinplast.com.mx" class="see-more-button" aria-label="Link to the pinplast website">
                            See more
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-circle" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5z"/>
                            </svg>
            ...
            <li>
                <figure>
                    <picture>
                        <!--
                        <source srcset="<?php echo get_theme_mod('img_portfolio3_jpg', get_bloginfo('template_url') . '/assets/img/revistaEstilo.jpg'); ?>" type="image/jpeg" media="(width => 1096px)">
                    ...
                    <figcaption>
                        ...
                        <button onclick="window.location.href='https://www.revistaestilo.com.mx';" class="see-more-button" aria-label="Link to the estilo magazine website">
                            See more
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-circle" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5z"/>
                            </svg>
