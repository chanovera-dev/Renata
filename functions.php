...
function custom_tag_list_with_svg($tags) {
    if ($tags) {
        $svg_icon = '
        ...
        // Cambia cada etiqueta para agregar el ícono.
        $tags = str_replace('<a', '<a>' . $svg_icon, $tags);
    }
    return $tags;
}

add_filter('get_the_tag_list', 'custom_tag_list_with_svg');
